  ...
  labelIt: [
    {
      ...
      // The two distractors are the misconceptions: the air does not leak out
      // (the thumb is on the hole) and water cannot be squashed.
      pins: [
        { id: 'p1', x: 200, y: 38, answer: 'water' },
        { id: 'p2', x: 560, y: 38, answer: 'air' },
        { id: 'p3', x: 284, y: 100, to: [204, 100], answer: 'plunger' },
        { id: 'p4', x: 284, y: 337, to: [258, 337], answer: 'thumb' },
        { id: 'p5', x: 200, y: 416, answer: 'nomove' },
        { id: 'p6', x: 560, y: 416, answer: 'moves' },
      ],
      bank: [
        { val: 'water', text: 'Syringe of water', textVn: 'Xi-lanh chứa nước' },
        { val: 'air', text: 'Syringe of air', textVn: 'Xi-lanh chứa khí' },
        { val: 'plunger', text: 'Plunger', textVn: 'Cần đẩy' },
        { val: 'thumb', text: 'Thumb over the hole', textVn: 'Ngón cái bịt lỗ' },
        { val: 'nomove', text: 'Will not move', textVn: 'Không nhúc nhích' },
        { val: 'moves', text: 'Slides in easily', textVn: 'Trượt vào dễ dàng' },
        { val: 'escapes', text: 'Air escapes', textVn: 'Khí thoát ra ngoài' },
        { val: 'squash', text: 'Water gets squashed', textVn: 'Nước bị nén lại' },
      ],
    },
    {
      id: 'arrangements',
      title: 'Label the three arrangements', titleVn: 'Gắn nhãn ba cách sắp xếp',
      inlineSvg: PARTICLES.THREE_ARRANGEMENTS, viewBox: '0 0 900 360', slotW: 250,
      // A name box over each square and a description box under it. The
      // distractor is a mix no state has — far apart AND in a pattern.
      pins: [
        { id: 'p1', x: 160, y: 38, answer: 'solid' },
        { id: 'p2', x: 450, y: 38, answer: 'liquid' },
        { id: 'p3', x: 740, y: 38, answer: 'gas' },
        { id: 'p4', x: 160, y: 300, answer: 'fixedpattern' },
        { id: 'p5', x: 450, y: 300, answer: 'touchslide' },
        { id: 'p6', x: 740, y: 300, answer: 'farapart' },
      ],
      bank: [
        { val: 'solid', text: 'Solid', textVn: 'Chất rắn' },
        { val: 'liquid', text: 'Liquid', textVn: 'Chất lỏng' },
        { val: 'gas', text: 'Gas', textVn: 'Chất khí' },
        { val: 'fixedpattern', text: 'Touching, in a fixed pattern', textVn: 'Sát nhau, xếp cố định' },
        { val: 'touchslide', text: 'Touching, no pattern', textVn: 'Sát nhau, không trật tự' },
        { val: 'farapart', text: 'Far apart, no pattern', textVn: 'Xa nhau, không trật tự' },
        { val: 'farpattern', text: 'Far apart, in a fixed pattern', textVn: 'Xa nhau, xếp cố định' },
      ],
    },
    {
      id: 'compressing',
      title: 'Label why the gas compresses', titleVn: 'Gắn nhãn vì sao chất khí bị nén',
      inlineSvg: PARTICLES.COMPRESSING_GAS, viewBox: '0 0 820 380', slotW: 250,
      // Before and after one push. The distractors are the two things students
      // guess happened instead of the gaps closing up.
      pins: [
        { id: 'p1', x: 185, y: 68, to: [262, 121], side: 'above', answer: 'plunger' },
        { id: 'p2', x: 635, y: 68, to: [635, 128], side: 'above', answer: 'push' },
        { id: 'p3', x: 185, y: 344, answer: 'biggaps' },
        { id: 'p4', x: 635, y: 344, answer: 'smallgaps' },
      ],
      bank: [
        { val: 'plunger', text: 'Plunger', textVn: 'Cần đẩy' },
        ...
        { val: 'smaller', text: 'Particles get smaller', textVn: 'Các hạt nhỏ đi' },
      ],
    },
  ],
