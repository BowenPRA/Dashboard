  ...
  labelIt: [
    {
      ...
      // "Nucleus" is the trap: the pale dent in the middle looks like one.
      pins: [
        { id: 'p1', x: 500, y: 60, to: [222, 50], answer: 'membrane' },
        { id: 'p2', x: 500, y: 130, to: [262, 130], answer: 'haemoglobin' },
        { id: 'p3', x: 500, y: 196, to: [184, 142], answer: 'no_nucleus' },
        { id: 'p4', x: 500, y: 262, to: [452, 262], answer: 'disc' },
      ],
      bank: [
        { val: 'membrane', text: 'Cell membrane', textVn: 'Màng tế bào' },
        { val: 'haemoglobin', text: 'Cytoplasm full of haemoglobin', textVn: 'Tế bào chất đầy hemoglobin' },
        { val: 'no_nucleus', text: 'No nucleus', textVn: 'Không có nhân' },
        { val: 'disc', text: 'Disc, dented on both sides', textVn: 'Hình đĩa lõm hai mặt' },
    ...
    },
    {
      ...
      inlineSvg: DIAGRAMS.NEURONE, viewBox: '0 0 760 320',
      // Cilia belong to the ciliated cell in this same lesson — a real mix-up.
      pins: [
        { id: 'p1', x: 380, y: 50, to: [318, 52], answer: 'dendrites' },
        { id: 'p2', x: 380, y: 105, to: [257, 174], answer: 'nucleus' },
        { id: 'p3', x: 380, y: 150, to: [292, 172], answer: 'cyto' },
        { id: 'p4', x: 310, y: 262, to: [286, 208], answer: 'membrane' },
        { id: 'p5', x: 520, y: 262, to: [520, 200], answer: 'axon' },
      ],
      bank: [
        ...
        { val: 'cilia', text: 'Cilia', textVn: 'Lông mao' },
        { val: 'wall', text: 'Cell wall', textVn: 'Thành tế bào' },
      ],
    },
    {
      ...
      // No chloroplasts underground — the distractor is the lesson.
      pins: [
        { id: 'p1', x: 130, y: 96, to: [140, 121], answer: 'wall' },
        { id: 'p2', x: 300, y: 96, to: [300, 177], answer: 'vacuole' },
        { id: 'p3', x: 90, y: 276, to: [90, 245], answer: 'membrane' },
        { id: 'p4', x: 250, y: 276, to: [207, 228], answer: 'nucleus' },
        { id: 'p5', x: 470, y: 276, to: [470, 194], answer: 'root_hair' },
      ],
      bank: [
        { val: 'wall', text: 'Cell wall', textVn: 'Thành tế bào' },
        { val: 'vacuole', text: 'Vacuole (cell sap)', textVn: 'Không bào (dịch bào)' },
        { val: 'membrane', text: 'Cell membrane', textVn: 'Màng tế bào' },
        { val: 'nucleus', text: 'Nucleus', textVn: 'Nhân' },
        { val: 'root_hair', text: 'Root hair', textVn: 'Lông hút' },
