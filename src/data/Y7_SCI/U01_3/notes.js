...
export const notes = [
  ...
  // 8 ─ Neurone + HOTSPOT ───────────────────────────────────────────────────
  {
    ...
    activity: {
      ...
      svg: DIAGRAMS.NEURONE, viewBox: '0 0 760 320',
      targets: [
        { id: 'dendrites', x: 190, y: 90, r: 45, name: 'a dendrite', nameVn: 'một sợi nhánh' },
        { id: 'nucleus', x: 242, y: 168, r: 24, name: 'the nucleus', nameVn: 'nhân' },
        { id: 'membrane', x: 290, y: 206, r: 18, name: 'the cell membrane', nameVn: 'màng tế bào' },
        { id: 'axon', x: 470, y: 194, r: 70, name: 'the axon', nameVn: 'sợi trục' },
      ],
      correct: 'axon',
