...
export const notes = [
  ...
  // 2 ─ Starter: HOTSPOT — the button you press most ──────────────────────────
  {
    ...
    text: 'Two buttons and a little wheel.',
    textVn: 'Hai nút và một bánh xe nhỏ.',
    sub: 'You will press one of them far more than anything else. Which one? Tap it on the mouse.',
    subVn: 'Có một nút em sẽ bấm nhiều hơn hẳn mọi thứ khác. Nút nào? Hãy chạm vào nó trên con chuột.',
    activity: {
      id: 'act_main_button',
      type: 'hotspot',
  ...
  // 4 ─ Four things a mouse does (steps + MOUSE_MOVES) ────────────────────────
  {
    ...
    content: 'Every mouse job is one of these four moves. Learn their English names.',
    contentVn: 'Mọi việc với con chuột đều là một trong bốn động tác này. Hãy học tên tiếng Anh của chúng.',
    inlineSvg: DIAGRAMS.MOUSE_MOVES,
    steps: [
      {
        text: '**Click:** press the **left** button **once**. It chooses a thing.',
        textVn: '**Bấm chuột (click):** bấm nút **trái** **một lần**. Nó chọn một thứ.',
      },
      {
        text: '**Double-click:** two **quick** clicks. It **opens** a file or folder.',
        textVn: '**Bấm đúp (double-click):** hai lần bấm **thật nhanh**. Nó **mở** một tệp hay thư mục.',
      },
      {
        text: '**Right-click:** press the **right** button. A **menu** opens.',
        textVn: '**Bấm chuột phải (right-click):** bấm nút **phải**. Một **trình đơn** mở ra.',
      },
      {
        text: '**Drag:** **hold** the left button, move, let go. It **moves** a thing.',
        textVn: '**Kéo thả (drag):** **giữ** nút trái, di chuột, thả tay. Nó **chuyển** một thứ.',
      },
    ],
    reveal: {
      label: 'It only turned blue. Why?',
      labelVn: 'Nó chỉ chuyển sang màu xanh. Vì sao?',
      prompt: 'You click a folder once to open it, and it just turns blue.',
      promptVn: 'Em bấm vào thư mục một lần để mở, và nó chỉ chuyển sang màu xanh.',
  ...
  // 5 ─ ESTIMATE — how quick is a double-click? ───────────────────────────────
  {
    ...
    labelVn: 'Ước lượng',
    labelIcon: 'Timer',
    text: 'A double-click is two **quick** clicks.',
    textVn: 'Bấm đúp là hai lần bấm **thật nhanh**.',
    sub: 'Wait too long and the computer hears two single clicks. About how many **seconds** can you leave between them? Slide to your guess.',
    subVn: 'Chờ quá lâu thì máy tính hiểu là hai lần bấm đơn. Em có thể để cách nhau khoảng bao nhiêu **giây**? Kéo thanh trượt đến dự đoán của em.',
    activity: {
      id: 'act_double_speed',
      type: 'estimate',
  ...
  // 6 ─ SORT — which move does the job? ───────────────────────────────────────
  {
    ...
    activity: {
      ...
      cards: [
        { id: 'save', name: 'Press the Save button', nameVn: 'Bấm nút Save', bin: 'click' },
        { id: 'choose', name: 'Choose Shut down', nameVn: 'Chọn Shut down', bin: 'click' },
        { id: 'folder', name: 'Open a folder\'s icon', nameVn: 'Mở biểu tượng thư mục', bin: 'double' },
        { id: 'paint', name: 'Start Paint from its icon', nameVn: 'Mở Paint từ biểu tượng', bin: 'double' },
        { id: 'menu', name: 'See what you can do to a file', nameVn: 'Xem việc có thể làm với tệp', bin: 'right' },
        { id: 'newfolder', name: 'Make a new folder', nameVn: 'Tạo thư mục mới', bin: 'right' },
        { id: 'photo', name: 'Move a photo into a folder', nameVn: 'Chuyển một bức ảnh vào một thư mục', bin: 'drag' },
        { id: 'bin', name: 'Put a file in the Recycle Bin', nameVn: 'Đưa tệp vào Thùng rác', bin: 'drag' },
      ],
  ...
  // 7 ─ No mouse? (TOUCH) + CHECK ─────────────────────────────────────────────
  {
    ...
    content: 'A tablet has a **touch screen**; a laptop has a **touchpad**. Both do the same four moves with a finger. One row of the table is one move.',
    contentVn: 'Máy tính bảng có **màn hình cảm ứng**; máy tính xách tay có **bàn di chuột**. Cả hai làm được bốn động tác đó bằng ngón tay. Mỗi hàng của bảng là một động tác.',
  ...
  // 10 ─ Drag and drop (steps + DRAG) ─────────────────────────────────────────
  {
    ...
    title: 'Drag and Drop',
    titleVn: 'Kéo và thả',
    content: 'Dragging moves a thing. The secret: **keep holding** until you get there.',
    contentVn: 'Kéo thả chuyển một thứ tới chỗ mới. Bí quyết: **cứ giữ nguyên** cho đến khi tới nơi.',
    ...
    reveal: {
      ...
      prompt: 'You let go too early. The photo dropped on the desktop.',
      promptVn: 'Em thả tay quá sớm. Bức ảnh rơi xuống màn hình nền.',
  ...
  // 13 ─ HOTSPOT — where do the keys go? (TWO_WINDOWS) ────────────────────────
  {
    ...
    labelVn: 'Chạm',
    labelIcon: 'MousePointerClick',
    text: 'Ha Vi just starts typing.',
    textVn: 'Hà Vi cứ thế bắt đầu gõ.',
    sub: 'She wants the next line of her story, and has not clicked anything. Tap the window her keys will go into.',
    subVn: 'Bạn ấy muốn gõ dòng tiếp theo của truyện, và chưa bấm vào đâu cả. Chạm vào cửa sổ sẽ nhận những phím bạn ấy gõ.',
    activity: {
  ...
  // 15 ─ Back to the story + CHECK ────────────────────────────────────────────
  {
    ...
    textVn: 'Bấm vào cửa sổ để đưa nó lên **phía trước**.',
    sub: 'Click **its button on the taskbar**, or **any part of it you can see**. Closing the window on top works too — but then that window is gone.',
    subVn: 'Bấm **nút của nó trên thanh tác vụ**, hoặc **bất kỳ phần nào của nó em nhìn thấy**. Đóng cửa sổ ở trên cùng cũng được — nhưng khi đó cửa sổ ấy mất luôn.',
    check: {
      id: 'chk_switch',
  ...
  // 17 ─ HOTSPOT — rub it out (Backspace) ─────────────────────────────────────
  {
    ...
    labelVn: 'Chạm',
    labelIcon: 'MousePointerClick',
    text: 'Ha Vi typed **catt**.',
    textVn: 'Hà Vi gõ **catt**.',
    sub: 'One letter too many, and the cursor is just after the last **t**. Tap the key that rubs out the letter just **before** the cursor.',
    subVn: 'Thừa một chữ cái, và con trỏ nằm ngay sau chữ **t** cuối cùng. Chạm vào phím xóa chữ cái nằm ngay **trước** con trỏ.',
    activity: {
      id: 'act_backspace',
      type: 'hotspot',
  ...
  // 21 ─ SORT — which shortcut? ───────────────────────────────────────────────
  {
    ...
    activity: {
      ...
      cards: [
        { id: 'oops', name: 'Rubbed out a sentence by mistake', nameVn: 'Lỡ xóa mất một câu', bin: 'undo' },
        { id: 'line', name: 'A wrong line spoiled a drawing', nameVn: 'Nét vẽ sai làm hỏng tranh', bin: 'undo' },
        { id: 'lunch', name: 'Lunch — keep your story safe', nameVn: 'Đi ăn trưa — giữ truyện an toàn', bin: 'save' },
        { id: 'para', name: 'Just wrote a good paragraph', nameVn: 'Vừa viết xong một đoạn hay', bin: 'save' },
        { id: 'title', name: 'Title in two places: take a copy', nameVn: 'Tiêu đề ở hai chỗ: lấy bản sao', bin: 'copy' },
        { id: 'sentence', name: 'Want a copy of a sentence', nameVn: 'Muốn bản sao của một câu', bin: 'copy' },
        { id: 'put', name: 'Put the copy at the cursor', nameVn: 'Đặt bản sao ở con trỏ', bin: 'paste' },
        { id: 'picture', name: 'Put a copied picture in', nameVn: 'Đưa tranh đã sao chép vào', bin: 'paste' },
      ],
  ...
  // 22 ─ Esc, the way out + HOTSPOT ───────────────────────────────────────────
  {
    ...
    labelVn: 'Chạm',
    labelIcon: 'MousePointerClick',
    text: '**Esc** means **get out** — safely.',
    textVn: '**Esc** nghĩa là **thoát ra** — an toàn.',
    sub: 'It never deletes anything. Tap the key that closes a menu **without choosing anything**.',
    subVn: 'Nó không bao giờ xóa thứ gì. Chạm vào phím đóng trình đơn **mà không chọn gì cả**.',
    activity: {
      id: 'act_esc',
      type: 'hotspot',
