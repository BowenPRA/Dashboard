  ...
  diagrams: [
    {
      ...
      imageAlt: 'Side view of a boy called Nam typing at a desk. He sits on the front edge of his chair, far from the backrest, with his back bent forward in a curve. His head is pushed forward and down, close to a screen that sits low on the desk. His wrists rest on the edge of the desk, bent upwards, and his feet hang in the air without reaching the floor.',
      ...
      options: [
        ...
        { val: 'C', text: 'Sit back in the chair with his back straight, and bring the screen up to eye level, about an arm’s length away.' },
        { val: 'D', text: 'Nothing — pain after typing is normal.' },
      ],
      correct: 'C',
      marks: 1,
      expEn: 'His back and neck hurt because he is bent over: perched on the front of the chair, his back curves, and his head leans down towards a low screen. Sitting back with a straight back, and raising the screen to eye level about an arm’s length away, fixes both. His feet and wrists need fixing too — a box under his feet, wrists floating above the keys — but they are not what hurts his back and neck. Pain is never "normal": it is a sign to change how you sit.',
      expVn: 'Lưng và cổ bạn ấy đau vì bạn ấy đang cúi gập người: ngồi ở mép ghế, lưng cong xuống, còn đầu thì chúi về phía màn hình đặt thấp. Ngồi lùi vào ghế với lưng thẳng, và nâng màn hình lên ngang tầm mắt, cách khoảng một sải tay, sẽ sửa được cả hai. Bàn chân và cổ tay của bạn ấy cũng cần sửa — kê một cái hộp dưới chân, cổ tay nâng nhẹ trên bàn phím — nhưng đó không phải lý do lưng và cổ bị đau. Đau không bao giờ là "bình thường": đó là dấu hiệu cần thay đổi cách ngồi.',
    },
    {
