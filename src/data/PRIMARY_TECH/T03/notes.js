...
export const notes = [
  ...
  // 2 ─ Starter: ESTIMATE — words a minute ────────────────────────────────────
  {
    ...
    labelVn: 'Ước lượng',
    labelIcon: 'Gauge',
    text: 'Someone who types with **all ten fingers**, without looking down, is copying a page of ordinary English.',
    textVn: 'Một người gõ bằng **cả mười ngón tay**, không nhìn xuống, đang chép lại một trang tiếng Anh bình thường.',
    sub: 'About how many **words a minute** (wpm) can they type? Slide to your guess.',
    subVn: 'Họ gõ được khoảng bao nhiêu **từ mỗi phút** (wpm)? Kéo thanh trượt đến dự đoán của em.',
    activity: {
      id: 'act_wpm',
      type: 'estimate',
  ...
  // 5 ─ SORT — good habit or bad habit ────────────────────────────────────────
  {
    ...
    activity: {
      ...
      cards: [
        { id: 'feet', name: 'Feet flat on the floor, or on a box', nameVn: 'Bàn chân đặt phẳng trên sàn, hoặc trên một cái hộp', bin: 'good' },
        { id: 'lean', name: 'Leaning in close to the screen', nameVn: 'Chúi người sát vào màn hình', bin: 'bad' },
        { id: 'back', name: 'Sitting back in the chair, back straight', nameVn: 'Ngồi sâu vào ghế, lưng thẳng', bin: 'good' },
        { id: 'rest', name: 'Resting your wrists on the desk and bending them up', nameVn: 'Tì cổ tay lên bàn rồi gập cổ tay lên', bin: 'bad' },
        { id: 'wrists', name: 'Wrists straight, floating just above the keys', nameVn: 'Cổ tay thẳng, nâng nhẹ ngay trên bàn phím', bin: 'good' },
        { id: 'edge', name: 'Perching on the front edge of the chair', nameVn: 'Ngồi ở mép trước của ghế', bin: 'bad' },
        { id: 'stretch', name: 'Stopping now and then to stretch your hands', nameVn: 'Thỉnh thoảng dừng lại để duỗi tay', bin: 'good' },
        { id: 'low', name: 'A screen so low that you look down at it', nameVn: 'Màn hình thấp đến mức em phải cúi nhìn xuống', bin: 'bad' },
      ],
  ...
  // 11 ─ PREDICT — one key out ────────────────────────────────────────────────
  {
    ...
    labelVn: 'Dự đoán',
    labelIcon: 'Sparkles',
    text: 'Your **left hand** slips **one key to the right**, and you do not notice. Every finger is now on its neighbour’s key.',
    textVn: '**Tay trái** của em bị trượt **sang phải một phím** mà em không để ý. Giờ mỗi ngón tay đều đang đặt trên phím của ngón bên cạnh.',
    sub: 'You try to type **sad**. What comes out?',
    subVn: 'Em định gõ chữ **sad**. Chữ gì sẽ hiện ra?',
    activity: {
      id: 'act_one_key_out',
      type: 'predict',
  ...
  // 13 ─ HOTSPOT — a key the right little finger presses ──────────────────────
  {
    ...
    labelVn: 'Chạm',
    labelIcon: 'MousePointerClick',
    text: 'Your **little fingers** look after the keys at the **edges** of the keyboard.',
    textVn: 'Hai **ngón út** của em phụ trách những phím ở **hai mép** bàn phím.',
  ...
  // 14 ─ Thumbs on the space bar + CHECK ──────────────────────────────────────
  {
    ...
    labelVn: 'Ý chính',
    labelIcon: 'Hand',
    text: 'Your **thumbs** rest on the **space bar** all the time. Tap it with **either thumb** after each word.',
    textVn: 'Hai **ngón cái** của em luôn đặt trên **phím cách**. Sau mỗi từ, hãy chạm nó bằng **một trong hai ngón cái**.',
    sub: 'Your eight fingers never leave the home row to make a space.',
    subVn: 'Tám ngón tay còn lại không bao giờ rời hàng phím cơ sở để tạo dấu cách.',
    check: {
      id: 'chk_space',
  ...
  // 15 ─ Reach, then come home (steps + REACH) ────────────────────────────────
  {
    ...
    content: 'Any key that is not on the home row is a **reach**: one finger goes out to it, presses it, and comes **straight back**.',
    contentVn: 'Phím nào không nằm trên hàng phím cơ sở thì là một lần **với**: một ngón tay đi ra, bấm phím đó, rồi **trở về ngay**.',
  ...
  // 17 ─ The other hand's Shift + HOTSPOT ─────────────────────────────────────
  {
    ...
    labelVn: 'Chạm',
    labelIcon: 'MousePointerClick',
    text: 'For a capital, the little finger of the **other** hand holds **Shift**, and the letter’s own finger presses the letter.',
    textVn: 'Để gõ chữ in hoa, ngón út của **tay kia** giữ phím **Shift**, còn ngón phụ trách chữ đó thì bấm chữ.',
    sub: 'A capital **T** is a left-hand key, so it takes the **right** Shift. Now you are typing **Hanoi**: tap the Shift you hold for the **H**.',
    subVn: 'Chữ **T** in hoa là phím của tay trái, nên dùng Shift **bên phải**. Giờ em đang gõ **Hanoi**: hãy chạm vào phím Shift em giữ để gõ chữ **H**.',
    activity: {
      id: 'act_shift_h',
      type: 'hotspot',
  ...
  // 18 ─ Enter and Backspace + CHECK ──────────────────────────────────────────
  {
    ...
    labelVn: 'Ý chính',
    labelIcon: 'Hand',
    text: '**Enter** and **Backspace** belong to your **right little finger**: a reach **right** to Enter, a reach **up** to Backspace — then straight back to ;.',
    textVn: '**Enter** và **Backspace** thuộc về **ngón út tay phải**: với **sang phải** để bấm Enter, với **lên trên** để bấm Backspace — rồi trở về phím ; ngay.',
    sub: 'Backspace rubs out the letter just before the **cursor** — the flashing line that shows where your next letter will go.',
    subVn: 'Backspace xoá chữ ngay trước **con trỏ** — vạch nhấp nháy cho biết chữ tiếp theo của em sẽ hiện ở đâu.',
    notes: [
      {
        tone: 'info',
        text: 'Made a mistake? Stop, tap **Backspace**, and type it again — straight away, while you can still see it. (The Typing Gym needs no Backspace: the line simply waits for the right key.)',
        textVn: 'Gõ sai à? Dừng lại, chạm **Backspace**, rồi gõ lại — làm ngay, khi em vẫn còn thấy lỗi. (Trong Phòng tập gõ phím không cần Backspace: dòng chữ chỉ đơn giản là chờ em gõ đúng phím.)',
      },
    ],
    check: {
      id: 'chk_enter',
  ...
  // 21 ─ Accuracy first + ESTIMATE ────────────────────────────────────────────
  {
    ...
    labelVn: 'Ước lượng',
    labelIcon: 'Target',
    text: '**Accuracy** means getting the keys **right**. Every wrong key has to be found, rubbed out and typed again — so a typist who rushes ends up **slower**.',
    textVn: '**Độ chính xác** là gõ **đúng** phím. Mỗi phím sai đều phải được tìm ra, xoá đi và gõ lại — nên người gõ vội vàng rốt cuộc lại **chậm hơn**.',
    sub: 'You press **50** keys and **5** are wrong. How many out of every **100** keys are right?',
    subVn: 'Em bấm **50** phím và **5** phím bị sai. Cứ **100** phím thì có bao nhiêu phím đúng?',
    activity: {
      id: 'act_accuracy',
      type: 'estimate',
  ...
  // 26 ─ On your own computer (unassessed, always last) ───────────────────────
  {
    ...
    content: 'Everything above was practice on a pretend keyboard. Now do it on a real one — that is the part that actually teaches your fingers.',
    contentVn: 'Tất cả những gì ở trên chỉ là luyện tập trên một bàn phím giả. Giờ hãy làm trên bàn phím thật — đó mới là phần thực sự dạy các ngón tay của em.',
    notes: [
      {
        tone: 'task',
