...
export const notes = [
  ...
  // 2 ─ Starter: HOTSPOT — the power symbol ───────────────────────────────────
  {
    ...
    text: 'Computers, tablets and phones all have these four little pictures somewhere on them.',
    textVn: 'Máy tính, máy tính bảng và điện thoại đều có bốn hình nhỏ này ở đâu đó trên máy.',
    sub: 'One of them means **power**. It is on the button that turns the machine on. Tap it.',
    subVn: 'Một trong số đó có nghĩa là **nguồn điện**. Nó nằm trên nút bật máy. Hãy chạm vào nó.',
    activity: {
      id: 'act_power_symbol',
      type: 'hotspot',
  ...
  // 7 ─ SORT — password habits ────────────────────────────────────────────────
  {
    ...
    labelVn: 'Sắp xếp',
    labelIcon: 'Layers',
    text: 'Some habits keep your account **yours**. Some give it away without you noticing.',
    textVn: 'Có những thói quen giữ tài khoản **là của em**. Có những thói quen làm lộ nó mà em không hề hay biết.',
    sub: 'Sort the six habits.',
    subVn: 'Hãy sắp xếp sáu thói quen.',
    activity: {
      ...
      cards: [
        { id: 'nobody', name: 'Telling nobody — not even your best friend', nameVn: 'Không nói cho ai — kể cả bạn thân nhất', bin: 'keep' },
        { id: 'logout', name: 'Logging out before you leave the computer', nameVn: 'Đăng xuất trước khi rời máy', bin: 'keep' },
        { id: 'hide', name: 'Typing it where nobody can see your fingers', nameVn: 'Nhập mật khẩu ở chỗ không ai thấy ngón tay em', bin: 'keep' },
        { id: 'note', name: 'A note stuck on the screen', nameVn: 'Một tờ giấy dán trên màn hình', bin: 'away' },
        { id: 'aloud', name: 'Saying it out loud as you type it', nameVn: 'Vừa nhập vừa đọc to mật khẩu', bin: 'away' },
  ...
  // 9 ─ HOTSPOT — the taskbar ─────────────────────────────────────────────────
  {
    ...
    labelVn: 'Chạm',
    labelIcon: 'MousePointerClick',
    text: 'The **taskbar** holds the menu button, the clock, and a button for **everything that is open**.',
    textVn: '**Thanh tác vụ** chứa nút trình đơn, đồng hồ, và một nút cho **mọi thứ đang mở**.',
    sub: 'Tap the taskbar on this screen.',
    subVn: 'Chạm vào thanh tác vụ trên màn hình này.',
    activity: {
      id: 'act_taskbar',
      type: 'hotspot',
  ...
  // 10 ─ HOTSPOT — the menu button ────────────────────────────────────────────
  {
    ...
    labelVn: 'Chạm',
    labelIcon: 'MousePointerClick',
    text: 'Every program on the computer is listed in one place: the **menu**. It is also where you go to **stop** the computer.',
    textVn: 'Mọi chương trình trên máy tính đều nằm trong một chỗ: **trình đơn**. Đó cũng là nơi em đến để **tắt** máy.',
    sub: 'Tap the button that opens it.',
    subVn: 'Chạm vào nút mở nó ra.',
    activity: {
      id: 'act_menu_button',
      type: 'hotspot',
  ...
  // 12 ─ HOTSPOT — the button that closes for good ────────────────────────────
  {
    ...
    labelVn: 'Chạm',
    labelIcon: 'MousePointerClick',
    text: 'Here is the top-right corner of Ha Vi’s story window, drawn big.',
    textVn: 'Đây là góc trên bên phải cửa sổ truyện của Hà Vi, được vẽ to.',
    sub: 'Tap the button that closes the window **for good**.',
    subVn: 'Chạm vào nút đóng cửa sổ **hẳn luôn**.',
    activity: {
      id: 'act_close_button',
      type: 'hotspot',
  ...
  // 14 ─ PREDICT — where did the minimised window go? ─────────────────────────
  {
    ...
    labelVn: 'Dự đoán',
    labelIcon: 'Sparkles',
    text: 'Ha Vi is writing a story. She has **not saved** it. She presses **minimise (–)** by mistake, and the window vanishes.',
    textVn: 'Hà Vi đang viết truyện. Bạn ấy **chưa lưu**. Bạn ấy lỡ bấm **thu nhỏ (–)**, và cửa sổ biến mất.',
    sub: 'Where is her story now?',
    subVn: 'Truyện của bạn ấy giờ ở đâu?',
    activity: {
  ...
  // 16 ─ SORT — which way to stop? ────────────────────────────────────────────
  {
    ...
    activity: {
      ...
      cards: [
        { id: 'dinner', name: 'Dinner — back in twenty minutes', nameVn: 'Ăn tối — hai mươi phút nữa quay lại', bin: 'sleep' },
        { id: 'break', name: 'A short break, then you carry on with the same work', nameVn: 'Nghỉ ngắn, rồi làm tiếp đúng bài đó', bin: 'sleep' },
        { id: 'sister', name: 'Your sister needs it for her own homework', nameVn: 'Chị em cần máy để làm bài tập của chị ấy', bin: 'logout' },
        { id: 'room', name: 'Leaving the school computer room for the next class', nameVn: 'Rời phòng máy của trường cho lớp sau vào', bin: 'logout' },
        { id: 'strange', name: 'A program is acting strangely, but the computer still answers', nameVn: 'Một chương trình chạy lạ, nhưng máy vẫn phản hồi', bin: 'restart' },
        { id: 'updates', name: 'A message says: updates are ready — start again to finish', nameVn: 'Có thông báo: bản cập nhật đã sẵn sàng — khởi động lại để hoàn tất', bin: 'restart' },
        { id: 'bedtime', name: 'Bedtime — nobody will use it until tomorrow', nameVn: 'Giờ đi ngủ — không ai dùng máy đến mai', bin: 'shutdown' },
        { id: 'holiday', name: 'Going away for the whole weekend', nameVn: 'Đi xa cả cuối tuần', bin: 'shutdown' },
      ],
  ...
  // 17 ─ Restart or shut down? (re- = again) + CHECK ──────────────────────────
  {
    ...
    labelIcon: 'Languages',
    text: '**Re-** means **again**: **re**start = start **again**. **Shut down** = stop, and stay **off**.',
    textVn: '**Re-** nghĩa là **lại**: **re**start = khởi động **lại**. **Shut down** = dừng, và **tắt** hẳn.',
    sub: 'Both of them close everything. Only one of them leaves the computer **off**.',
    subVn: 'Cả hai đều đóng mọi thứ. Chỉ một trong hai để máy **tắt** hẳn.',
    notes: [
      {
        tone: 'write',
  ...
  // 22 ─ FROZEN + CHECK ───────────────────────────────────────────────────────
  {
    ...
    labelVn: 'Từ khóa',
    labelIcon: 'Snowflake',
    text: 'A computer is **frozen** when **nothing answers**: the pointer will not move, the keys do nothing, and the clock has stopped.',
    textVn: 'Máy tính **bị treo** khi **không gì phản hồi**: con trỏ không nhúc nhích, bấm phím chẳng có tác dụng, và đồng hồ đứng yên.',
    sub: 'That — and **only** that — is when you hold the power button down.',
    subVn: 'Đó — và **chỉ** lúc đó — mới là lúc em giữ nút nguồn.',
    notes: [
      {
        tone: 'write',
  ...
  // 23 ─ ESTIMATE — how long do you hold it? ──────────────────────────────────
  {
    ...
    labelVn: 'Ước lượng',
    labelIcon: 'Timer',
    text: 'The computer is frozen. You hold the power button **down** and keep holding.',
    textVn: 'Máy bị treo. Em giữ nút nguồn **xuống** và cứ giữ nguyên.',
    sub: 'About how many **seconds** until it switches off? Slide to your guess.',
    subVn: 'Khoảng bao nhiêu **giây** thì máy tắt? Kéo thanh trượt đến dự đoán của em.',
    activity: {
      id: 'act_hold_seconds',
      type: 'estimate',
  ...
  // 24 ─ HOTSPOT — locked, or off? ────────────────────────────────────────────
  {
    ...
    labelVn: 'Chạm',
    labelIcon: 'MousePointerClick',
    text: 'A **locked** computer is still **on**: anything left open is still there, behind the login screen. A computer that is **off** has no lights and no fan.',
    textVn: 'Máy tính đang **khóa** thì vẫn **bật**: mọi thứ còn mở vẫn ở đó, phía sau màn hình đăng nhập. Máy tính đã **tắt** thì không có đèn và không có tiếng quạt.',
    sub: 'Look at the **lights**, not the screen.',
    subVn: 'Hãy nhìn **đèn**, đừng nhìn màn hình.',
    activity: {
      id: 'act_still_on',
      type: 'hotspot',
