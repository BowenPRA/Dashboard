...
export const notes = [
  ...
  // 2 ─ Starter: HOTSPOT — which icon opens websites? ──────────────────────
  {
    ...
    text: 'This is the **taskbar** along the bottom of a computer screen. Each picture on it opens a different **program**.',
    textVn: 'Đây là **thanh tác vụ** chạy dọc phía dưới màn hình máy tính. Mỗi hình trên đó mở một **chương trình** khác nhau.',
  ...
  // 5 ─ HOTSPOT — the address bar ───────────────────────────────────────────
  {
    ...
    labelVn: 'Chạm',
    labelIcon: 'MousePointerClick',
    text: 'The **address bar** belongs to the **browser**, not to the page. It sits above **every** website, and it always shows **where you are**.',
    textVn: '**Thanh địa chỉ** thuộc về **trình duyệt**, không thuộc về trang web. Nó nằm phía trên **mọi** trang web, và luôn cho biết **em đang ở đâu**.',
    sub: 'Tap the box that shows which website is open — the box that could take you to any other one.',
    subVn: 'Chạm vào ô cho biết trang web nào đang mở — cái ô có thể đưa em tới bất kỳ trang nào khác.',
    activity: {
      id: 'act_address_bar',
      type: 'hotspot',
  ...
  // 6 ─ HOTSPOT — the button that opens a new tab ───────────────────────────
  {
    ...
    labelVn: 'Chạm',
    labelIcon: 'MousePointerClick',
    text: 'Along the very top is a row of **tabs**: one for each page you have open. Three pages are open here.',
    textVn: 'Trên cùng là một hàng **thẻ**: mỗi thẻ là một trang em đang mở. Ở đây đang mở ba trang.',
    sub: 'Tap the button that opens a **new, empty tab** — without closing anything.',
    subVn: 'Chạm vào nút mở một **thẻ mới, trống** — mà không đóng thứ gì cả.',
    activity: {
      id: 'act_new_tab',
      type: 'hotspot',
  ...
  // 13 ─ SORT — address, or words? ──────────────────────────────────────────
  {
    ...
    labelVn: 'Phân loại',
    labelIcon: 'Columns3',
    text: 'An **address** is a place to **go**. It has no spaces, and it has dots and an ending: **www.kidsmaths.org**.',
    textVn: 'Một **địa chỉ** là một nơi để **đến**. Nó không có dấu cách, và có dấu chấm cùng phần đuôi: **www.kidsmaths.org**.',
    sub: '**Words** are something to **find**, like **times tables games**. They have spaces, and no ending.',
    subVn: '**Các từ** là thứ để **tìm**, ví dụ **times tables games**. Chúng có dấu cách, và không có phần đuôi.',
    activity: {
  ...
  // 14 ─ HOTSPOT — the link on a page ───────────────────────────────────────
  {
    ...
    labelVn: 'Chạm',
    labelIcon: 'MousePointerClick',
    text: 'A **link** is words (or a picture) you click to go to **another page**. Links are usually **blue** and **underlined**, and the pointer turns into a **hand** when it is over one.',
    textVn: '**Liên kết** là chữ (hoặc hình) em bấm vào để sang **một trang khác**. Liên kết thường có **màu xanh** và **gạch chân**, và con trỏ chuột biến thành **bàn tay** khi đặt lên nó.',
    sub: 'This page has **one** link. Tap it.',
    subVn: 'Trang này có **một** liên kết. Hãy chạm vào nó.',
    activity: {
      id: 'act_link',
      type: 'hotspot',
  ...
  // 17 ─ ORDER — the five steps of a second tab ─────────────────────────────
  {
    ...
    text: 'You are reading your **homework**, and you need the City Library website **as well**.',
    textVn: 'Em đang đọc **bài tập về nhà**, và em cần **thêm** website Thư viện Thành phố.',
    sub: 'Put the five steps in order.',
    subVn: 'Sắp xếp năm bước theo đúng thứ tự.',
    activity: {
      id: 'act_tab_steps',
      type: 'order',
  ...
  // 19 ─ SORT — which button fixes it? ──────────────────────────────────────
  {
    ...
    activity: {
      ...
      cards: [
        { id: 'wronglink', name: 'You clicked a link by mistake.', nameVn: 'Em lỡ bấm nhầm một liên kết.', bin: 'back' },
        { id: 'nopicture', name: 'A picture on the page did not appear.', nameVn: 'Một tấm hình trên trang không hiện ra.', bin: 'reload' },
        { id: 'toofar', name: 'You pressed Back one time too many.', nameVn: 'Em bấm Quay lại thừa một lần.', bin: 'fwd' },
        { id: 'halfway', name: 'The page stopped loading halfway.', nameVn: 'Trang dừng tải giữa chừng.', bin: 'reload' },
        { id: 'before', name: 'You want the page you were on a minute ago.', nameVn: 'Em muốn về trang vừa xem một phút trước.', bin: 'back' },
        { id: 'return', name: 'You went back to check something, and now want to return.', nameVn: 'Em quay lại để xem một thứ, và giờ muốn trở về.', bin: 'fwd' },
      ],
  ...
  // 20 ─ Bookmark (statement) + CHECK ───────────────────────────────────────
  {
    ...
    text: 'Clicking the **star** (or pressing **Ctrl+D**) saves this page in a list, so you can come back to it tomorrow without remembering the address.',
    textVn: 'Bấm vào **ngôi sao** (hoặc bấm **Ctrl+D**) sẽ lưu trang này vào một danh sách, để mai em quay lại mà không cần nhớ địa chỉ.',
    sub: 'A bookmark is a **way back**, not a copy. If the website changes, your bookmark shows the new version — and if the site disappears, so does the page.',
    subVn: 'Dấu trang là **đường quay lại**, không phải bản sao. Nếu website thay đổi, dấu trang sẽ hiện bản mới — và nếu trang biến mất thì dấu trang cũng không mở được nữa.',
    notes: [
      {
        tone: 'write',
  ...
  // 22 ─ HOTSPOT — the button that shows where it went ──────────────────────
  {
    ...
    labelVn: 'Chạm',
    labelIcon: 'MousePointerClick',
    text: 'You clicked **Download PDF**. The bar along the bottom is the browser **telling you** what happened to the file.',
    textVn: 'Em đã bấm **Download PDF**. Thanh chạy dọc phía dưới là lúc trình duyệt **cho em biết** chuyện gì đã xảy ra với tệp.',
    sub: 'Tap the button that opens the **folder** the file was saved in.',
    subVn: 'Chạm vào nút mở **thư mục** nơi tệp được lưu.',
    activity: {
      id: 'act_show_folder',
      type: 'hotspot',
