...
export const notes = [
  ...
  // 2 ─ Starter: PREDICT — the power cut ───────────────────────────────────
  {
    ...
    labelVn: 'Dự đoán',
    labelIcon: 'Sparkles',
    text: 'An hour of typing. You never pressed **Save**.',
    textVn: 'Gõ suốt một giờ. Em chưa hề bấm **Save** (Lưu).',
  ...
  // 11 ─ PREDICT — one file or two? ────────────────────────────────────────
  {
    ...
    labelVn: 'Dự đoán',
    labelIcon: 'Sparkles',
    text: '**volcano report** is open. You press **Save As**.',
    textVn: '**volcano report** đang mở. Em bấm **Save As**.',
    sub: 'It is saved in Documents. You type a new name, **volcano report 2**, and press Save. How many volcano reports are in Documents now?',
    subVn: 'Nó đã được lưu trong Documents. Em gõ một cái tên mới, **volcano report 2**, rồi bấm Save. Bây giờ trong Documents có bao nhiêu bài báo cáo núi lửa?',
    activity: {
      id: 'act_how_many',
      type: 'predict',
  ...
  // 16 ─ Where things live + SORT ──────────────────────────────────────────
  {
    ...
    activity: {
      ...
      cards: [
        { id: 'story', name: 'A story you wrote', nameVn: 'Câu chuyện em viết', bin: 'documents' },
        { id: 'project', name: 'Your science project', nameVn: 'Dự án khoa học của em', bin: 'documents' },
        { id: 'sheet', name: 'A worksheet just downloaded', nameVn: 'Phiếu bài tập vừa tải về', bin: 'downloads' },
        { id: 'picture', name: 'A picture from a website', nameVn: 'Tấm ảnh tải từ trang web', bin: 'downloads' },
        { id: 'reminder', name: 'A reminder for today', nameVn: 'Lời nhắc cho hôm nay', bin: 'desktop' },
        { id: 'drawing', name: 'A drawing you deleted', nameVn: 'Bức vẽ em đã xoá', bin: 'bin' },
      ],
  ...
  // 20 ─ Delete is a move + CHECK ──────────────────────────────────────────
  {
    ...
    text: 'You delete the **wrong** file.',
    textVn: 'Em xoá **nhầm** tệp.',
    sub: 'It vanishes from the folder — but it is not gone. Knowing where it went is worth more than being careful: everybody deletes something by mistake one day.',
    subVn: 'Nó biến mất khỏi thư mục — nhưng chưa mất đâu. Biết nó đã đi đâu còn quý hơn cả sự cẩn thận: ai rồi cũng có ngày lỡ tay xoá nhầm.',
    check: {
      id: 'chk_bin',
  ...
  // 22 ─ PREDICT — emptying the bin ────────────────────────────────────────
  {
    ...
    labelVn: 'Dự đoán',
    labelIcon: 'Sparkles',
    text: 'The bin has a button: **Empty Recycle Bin**.',
    textVn: 'Thùng rác có một nút: **Empty Recycle Bin**.',
    sub: 'Your Recycle Bin is full of old files. What happens to them when you press it?',
    subVn: 'Recycle Bin của em đầy những tệp cũ. Chuyện gì xảy ra với chúng khi em bấm nút đó (dọn sạch thùng rác)?',
    activity: {
      id: 'act_empty_bin',
      type: 'predict',
