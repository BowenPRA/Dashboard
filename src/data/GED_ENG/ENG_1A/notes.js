    ...
    columns: [
      {
        ...
        accent: "#0087a8",
        icon: "HelpCircle",
        content: "e.g. **school lunches** (just the subject).",
        contentVn: "vd: **bữa trưa ở trường** (chỉ là đề tài).",
        notes: [{ tone: "write", text: "**Topic:** what the text is about — a word or short phrase.", textVn: "**Chủ đề:** nội dung văn bản nói về cái gì — một từ hoặc cụm từ ngắn." }],
      },
      {
        heading: "Main Idea",
        headingVn: "Ý chính",
        accent: "#c25e12",
        icon: "Target",
        content: "e.g. **School lunches should be healthier.**",
        contentVn: "vd: **Bữa trưa ở trường nên lành mạnh hơn.**",
        notes: [{ tone: "write", text: "**Main idea:** the point the writer makes about the topic — a full sentence.", textVn: "**Ý chính:** điểm người viết nêu ra về chủ đề — một câu hoàn chỉnh." }],
      },
    ],
