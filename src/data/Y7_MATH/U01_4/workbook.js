...
export const workbook = [
  {
    ...
    questions: [
      {
        id: 'f1', prompt: 'Find the **highest common factor** of 8 and 12.', promptVn: 'Tìm **ước số chung lớn nhất** của 8 và 12.',
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 'p3', prompt: 'List **all** the common factors of 24 and 36.', promptVn: 'Liệt kê **tất cả** ước số chung của 24 và 36.',
        solution: ['Factors of 24: 1, 2, 3, 4, 6, 8, 12, 24. Factors of 36: 1, 2, 3, 4, 6, 9, 12, 18, 36.', 'The ones in both lists are $1, 2, 3, 4, 6, 12$.'],
        solutionVn: ['Ước số của 24: 1, 2, 3, 4, 6, 8, 12, 24. Ước số của 36: 1, 2, 3, 4, 6, 9, 12, 18, 36.', 'Những số ở cả hai là $1, 2, 3, 4, 6, 12$.'],
        answer: '$1, 2, 3, 4, 6, 12$', answerVn: '$1, 2, 3, 4, 6, 12$',
      },
      {
        id: 'p4', prompt: 'Use the HCF to write $\\frac{20}{30}$ in its simplest form.', promptVn: 'Dùng ƯCLN để viết $\\frac{20}{30}$ ở dạng tối giản.',
