...
// include the two word problems demoted from the classroom deck (The Biscuit
// Tins, The School Hall) and the digit-shuffle investigation. Answers are Yes/No
// (graded by the string fallback) or a count. See docs/workbook-tasks.md.
...
export const workbook = [
  {
    ...
    questions: [
      {
        id: 'f1', prompt: 'Using a test (not a calculator): is **4728** divisible by **2**?', promptVn: 'Dùng dấu hiệu (không dùng máy tính): **4728** có chia hết cho **2** không?',
        ...
        answer: 'Yes', answerVn: 'Yes',
      },
      {
        id: 'f2', prompt: 'Is **615** divisible by **5**?', promptVn: '**615** có chia hết cho **5** không?',
      ...
      {
        id: 'f3', prompt: 'Is **4725** divisible by **3**?', promptVn: '**4725** có chia hết cho **3** không?',
      ...
      {
        id: 'f4', prompt: 'Is **3960** divisible by **10**?', promptVn: '**3960** có chia hết cho **10** không?',
  ...
  },
  {
    ...
    questions: [
      {
        id: 'p1', prompt: 'Is **5304** divisible by **4**?', promptVn: '**5304** có chia hết cho **4** không?',
      ...
      {
        id: 'p2', prompt: 'Is **2916** divisible by **9**?', promptVn: '**2916** có chia hết cho **9** không?',
      ...
      {
        id: 'p3', prompt: 'Is **84** divisible by **6**?', promptVn: '**84** có chia hết cho **6** không?',
      ...
      {
        id: 'p4', prompt: 'Is **92** divisible by **6**?', promptVn: '**92** có chia hết cho **6** không?',
        ...
        answer: 'No', answerVn: 'No',
      },
      {
        id: 'p5', prompt: 'Use the test for 11: is **2915** divisible by **11**?', promptVn: 'Dùng dấu hiệu cho 11: **2915** có chia hết cho **11** không?',
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 'c3', prompt: 'Using the digits **8, 3, 6, 1** each exactly once, can you build a four-digit number that is **not** divisible by 9? Answer Yes or No, and explain.', promptVn: 'Dùng các chữ số **8, 3, 6, 1** mỗi số đúng một lần, em có thể tạo một số bốn chữ số **không** chia hết cho 9 không? Trả lời Có hoặc Không, và giải thích.',
